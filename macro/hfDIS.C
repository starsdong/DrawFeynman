...
void hfDIS()
{
   ...
   // charm quarks
   drawArrowLine(45, 35, 45, 50, 0.03, 30, 1, 1, kBlue);
   drawArrowLine(45, 50, 60, 54, 0.03, 30, 1, 1, kBlue);
   drawArrowLine(60, 32, 45, 35, 0.03, 30, 1, 1, kBlue);
   drawText(51, 53.5, "c", 32, 0.06, 0, kBlue);
   drawText(51, 35, "#bar{c}", 32, 0.06, 0, kBlue);
   drawGluon(35, 24, 45, 35, 1, 1, kRed+1);
   drawText(35, 32, "x_{g}", 32, 0.07, 0, kRed);

   drawArrowLine(65, 55, 90, 61.5, 0.03, 30, 3, 1, kBlue);
   //   drawArrowLine(90, 61, 65, 54.5, 0.03, 30, 1, 1, kBlue);
   drawText(72, 52, "D", 32, 0.08, 0, kBlue);
   drawEllipse(62.5, 54.5, 2.8, 2.8, 0., 360., 0., 3005, kBlue, 1, 1, kBlue);
   
   //   drawArrowLine(65, 30, 90, 25, 0.03, 30, 3, 1, kBlue);
   drawArrowLine(90, 26., 65, 31., 0.03, 30, 3, 1, kBlue);
   drawText(72, 32., "#bar{D}", 32, 0.08, 0, kBlue);
